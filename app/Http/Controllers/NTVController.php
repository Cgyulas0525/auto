...
class NTVController extends AppBaseController
{
    ...
    public function show($id)
    {
        ...
        return view('ntv.show')->with('account', $account);
    }
    ...
    public function edit($id)
    {
        ...
        return view('ntv.edit')->with('account', $account);
    }
