...
class IoaccountsController extends AppBaseController
{
    ...
    public function store(CreateIoaccountsRequest $request)
    {
        ...
        return redirect(route('ioaccounts.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('ioaccounts.show')->with('ioaccounts', $ioaccounts);
    }
    ...
    public function edit($id)
    {
        ...
        return view('ioaccounts.edit')->with('ioaccounts', $ioaccounts);
    }
