...
class NESController extends AppBaseController
{
    ...
    public function store(CreateAccountRequest $request)
    {
        ...
        return redirect(route('nes.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('nes.show')->with('account', $account);
    }
    ...
    public function edit($id)
    {
        ...
        return view('nes.edit')->with('account', $account);
    }
