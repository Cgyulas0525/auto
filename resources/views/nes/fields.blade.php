...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('auto', \App\Models\Car::where('id', '=', '5')->pluck('rendszam', 'id')->toArray(), null,['style' => 'cursor: not-allowed','class'=>'select form-control', 'readonly' => 'true', 'id' => 'auto']) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('rvp.index') !!}" class="btn btn-default">Kilép</a>
</div>
