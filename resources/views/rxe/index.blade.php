...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">RXE 970 Számlák</h1>
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('rxe.create') !!}"><i class="fa fa-plus-square"></i></a>
        </h1>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
              <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered rxe-table">
                        <thead>
                            <tr>
                                <th>Autó</th>
                                <th>Partner</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
          ...
          var oTable = $('.rxe-table').DataTable({
              language: {
